...
// UpdateOneID returns an update builder for the given id.
func (c *MessageClient) UpdateOneID(id types.ChatID) *MessageUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *MessageClient) DeleteOneID(id types.ChatID) *MessageDeleteOne {
...
func (c *MessageClient) Get(ctx context.Context, id types.ChatID) (*Message, error) {
	return c.Query().Where(message.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *MessageClient) GetX(ctx context.Context, id types.ChatID) *Message {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
