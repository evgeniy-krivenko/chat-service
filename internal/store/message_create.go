...
func (u *MessageUpsert) ClearProblemID() *MessageUpsert {
	u.SetNull(message.FieldProblemID)
	return u
}
...
func (u *MessageUpsert) ClearIsVisibleForClient() *MessageUpsert {
	u.SetNull(message.FieldIsVisibleForClient)
	return u
}
...
func (u *MessageUpsert) ClearIsVisibleForManager() *MessageUpsert {
	u.SetNull(message.FieldIsVisibleForManager)
	return u
}
...
func (u *MessageUpsert) ClearIsBlocked() *MessageUpsert {
	u.SetNull(message.FieldIsBlocked)
	return u
}
...
func (u *MessageUpsert) ClearIsService() *MessageUpsert {
	u.SetNull(message.FieldIsService)
	return u
}
...
// ClearProblemID clears the value of the "problem_id" field.
func (u *MessageUpsertOne) ClearProblemID() *MessageUpsertOne {
	return u.Update(func(s *MessageUpsert) {
		s.ClearProblemID()
	})
}
...
// ClearIsVisibleForClient clears the value of the "is_visible_for_client" field.
func (u *MessageUpsertOne) ClearIsVisibleForClient() *MessageUpsertOne {
	return u.Update(func(s *MessageUpsert) {
		s.ClearIsVisibleForClient()
	})
}
...
// ClearIsService clears the value of the "is_service" field.
func (u *MessageUpsertOne) ClearIsService() *MessageUpsertOne {
	return u.Update(func(s *MessageUpsert) {
		s.ClearIsService()
	})
}
...
// ClearProblemID clears the value of the "problem_id" field.
func (u *MessageUpsertBulk) ClearProblemID() *MessageUpsertBulk {
	return u.Update(func(s *MessageUpsert) {
		s.ClearProblemID()
	})
}
...
// ClearIsVisibleForClient clears the value of the "is_visible_for_client" field.
func (u *MessageUpsertBulk) ClearIsVisibleForClient() *MessageUpsertBulk {
	return u.Update(func(s *MessageUpsert) {
		s.ClearIsVisibleForClient()
	})
}
...
// ClearIsService clears the value of the "is_service" field.
func (u *MessageUpsertBulk) ClearIsService() *MessageUpsertBulk {
	return u.Update(func(s *MessageUpsert) {
		s.ClearIsService()
	})
}
