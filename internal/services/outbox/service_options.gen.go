...
func (o *Options) Validate() error {
	...
	errs.Add(errors461e464ebed9.NewValidationError("trxtor", _validate_Options_trxtor(o)))
	return errs.AsError()
}
...
func _validate_Options_trxtor(o *Options) error {
	if err := validator461e464ebed9.GetValidatorFor(o).Var(o.trxtor, "required"); err != nil {
		return fmt461e464ebed9.Errorf("field `trxtor` did not pass the test: %w", err)
	}
	return nil
}
