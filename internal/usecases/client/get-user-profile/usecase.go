...
//go:generate mockgen -source=$GOFILE -destination=mocks/usecase_mock.gen.go -package=getuserprofilemocks
...
func (u UseCase) Handle(ctx context.Context, req Request) (Response, error) {
	...
	profile, err := u.profilesRepo.GetProfileByID(ctx, req.UserID)
